...
# Ridge OOF RMSE: 0.239511 -- image and structured

gc.collect()


ridge_preds = np.concatenate([ridge_oof_train, ridge_oof_test])
df['ridge_imgstr_preds'] = ridge_preds
df[['ridge_imgstr_preds']].to_csv(path + '../features/ridgeImgStr5CV.csv.gz', compression = 'gzip', index = False)
