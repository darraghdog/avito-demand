...
featrdgprc = pd.read_csv(path + '../features/price_category_ratios_2505A.gz', compression = 'gzip') # created with features/make/user_actagg_1705.py
...
plt.savefig(path + '../plots/feature_import_2505A.png')
...
lgsub.to_csv("../sub/lgsub_2505A.csv.gz",index=True,header=True, compression = 'gzip')
