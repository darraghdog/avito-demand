...
featseqfst = pd.read_csv(path + '../features/agg_seqtyp_1306.gz', compression = 'gzip')
featimgfst = pd.read_csv(path + '../features/agg_imgpresence_1306.gz', compression = 'gzip')
...
df.head()
df = pd.concat([df.reset_index(),featenc, featct, featrdgtxt, featrdgprc, featimgprc, featimgfst, featseqfst, \
...
df.columns
del featusrttl, featusrcat, featusrprd, featenc, featrdgprc, featimgprc, featrdgrnk, featnumf, featprmenc, featprmtro, featencfst, featprtfst, featimgfst, featseqfst
