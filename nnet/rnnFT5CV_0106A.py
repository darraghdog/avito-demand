...
word_vectors = KeyedVectors.load_word2vec_format(path+ '../features/wiki.ru.vec', binary=False)
...
df[['rnn_preds']].to_csv('../sub/rnnCV_0106A.csv.gz', index=True, header=True, compression='gzip')
